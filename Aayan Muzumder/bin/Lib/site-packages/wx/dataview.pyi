...
class DataViewListCtrl(DataViewCtrl):
    ...
    def AppendTextColumn(self, label, mode=DATAVIEW_CELL_INERT, width=wx.COL_WIDTH_DEFAULT, align=wx.ALIGN_LEFT, flags=DATAVIEW_COL_RESIZABLE):
        """
    ...
    def AppendToggleColumn(self, label, mode=DATAVIEW_CELL_ACTIVATABLE, width=wx.COL_WIDTH_DEFAULT, align=wx.ALIGN_LEFT, flags=DATAVIEW_COL_RESIZABLE):
        """
    ...
    def AppendProgressColumn(self, label, mode=DATAVIEW_CELL_INERT, width=wx.COL_WIDTH_DEFAULT, align=wx.ALIGN_LEFT, flags=DATAVIEW_COL_RESIZABLE):
        """
    ...
    def AppendIconTextColumn(self, label, mode=DATAVIEW_CELL_INERT, width=wx.COL_WIDTH_DEFAULT, align=wx.ALIGN_LEFT, flags=DATAVIEW_COL_RESIZABLE):
        """
...
class DataViewTreeStore(DataViewModel):
    ...
    def AppendContainer(self, parent, text, icon=wx.BitmapBundle(), expanded=wx.BitmapBundle(), data=None):
        """
    ...
    def AppendItem(self, parent, text, icon=wx.BitmapBundle(), data=None):
        """
    ...
    def InsertContainer(self, parent, previous, text, icon=wx.BitmapBundle(), expanded=wx.BitmapBundle(), data=None):
        """
    ...
    def InsertItem(self, parent, previous, text, icon=wx.BitmapBundle(), data=None):
        """
    ...
    def PrependContainer(self, parent, text, icon=wx.BitmapBundle(), expanded=wx.BitmapBundle(), data=None):
        """
    ...
    def PrependItem(self, parent, text, icon=wx.BitmapBundle(), data=None):
        """
